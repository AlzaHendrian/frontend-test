<template>
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-20 gap-4 md:gap-14">
    <div class="flex flex-col lg:flex-row justify-between w-full gap-14">
      <div v-if="articleDetail" class="w-full lg:w-2/3 px-2 md:px-4 lg:px-8 py-4 md:py-6 lg:py-12">
